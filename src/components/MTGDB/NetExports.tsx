      ...
      for (const card of json) {
        ...
        if (check === undefined) {
          ...
          const newEntry: CardsTableType = {
            ...
            set_name: card.set_name || newCard.set_name,
            rarity: card.rarity || newCard.rarity,
            mana_cost: card.mana_cost || newCard.mana_cost,
            cmc: card.cmc || newCard.cmc,
            image_uri: imgUris,
            colors: colors,
            color_identity: newCard.color_identity,
            tags: card.tags,
            type_line: card.type_line || newCard.type_line,
